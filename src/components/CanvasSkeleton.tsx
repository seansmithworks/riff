...
function GhostPhoneFrame() {
  return (
    <div className="flex shrink-0 flex-col items-center gap-3">
      <div className="h-3 w-16 rounded-full bg-zinc-800 motion-safe:animate-pulse" />
      <div
...
export function GeneratingIndicator() {
  return (
    <div className="pointer-events-none absolute top-4 left-1/2 z-10 -translate-x-1/2 rounded-full border border-zinc-700 bg-zinc-900/90 px-4 py-1.5 shadow-lg backdrop-blur-sm">
